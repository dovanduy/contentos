...
{
    public class GetTaskbyTagInteractionHandler : IRequestHandler<GetTaskbyTagInteractionRequest, List<StaticsDetailModel>>
    {
        ...
        public async Task<List<StaticsDetailModel>> Handle(GetTaskbyTagInteractionRequest request, CancellationToken cancellationToken)
        {
